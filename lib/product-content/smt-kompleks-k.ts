...
export const SMT_KOMPLEKS_K_CONTENT: ProductRichContent = {
  ...
  description: [
    ...
    { type: "heading", text: "Смарт-функции", level: 3 },
    {
      type: "list",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "обнаружения расхода газа после открытия клапана — счётчик газа с запорным клапаном СМТ-Комплекс-К при передаче данных на сервер вместе с архивами измерений передаёт данные архивов по событиям клапана."
      ]
    },
    {
      type: "paragraph",
      text: "Система самодиагностики счётчика газа с запорным клапаном СМТ-Комплекс-К постоянно контролирует работоспособность основных узлов прибора, в том числе работу запорного клапана. Архивы, передаваемые на сервер, кроме данных об объёме газа, прошедшего через счётчик, содержат информацию о текущем состоянии клапана и его изменениях с указанием времени и причин их вызвавших."
    },
  ...
  specs: [
    ...
    },
    {
      ...
      value: ["G4 — 150", "G6 — 250", "G10 — 350", "G16 — 650", "G25 — 1300"].join("\n")
    },
    {
    ...
    },
    {
      ...
      value: [
        ...
        "Архив изменений — предназначен для контроля и хранения данных обо всех изменениях настраиваемых параметров СМТ-Комплекс-К;",
        ...
        "Архив системный — предназначен для фиксации сервисной информации по сбоям аппаратных систем и ПО СМТ-Комплекс-К."
      ].join("\n")
    },
    {
  ...
  dimensions: {
    title: "Габаритные и присоединительные размеры счётчиков СМТ-Комплекс-К",
    imageSrc: "/media/products/smt/smt-kompleks-k-dimensions.png",
    imageAlt: "Габаритные и присоединительные размеры счётчиков СМТ-Комплекс-К",
    caption:
