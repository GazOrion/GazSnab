...
export const SMT_KOMPLEKS_G65_G100_CONTENT: ProductRichContent = {
  ...
  specs: [
    {
      ...
      value: "G65 — от 0,65 м³/ч до 110 м³/ч, Qном = 65 м³/ч\nG100 — от 1,1 м³/ч до 176 м³/ч, Qном = 100 м³/ч"
    },
    {
  ...
  dimensions: {
    title: "Габаритные и присоединительные размеры счётчиков СМТ-Комплекс G65 и G100",
    imageSrc: "/media/products/smt/smt-kompleks-g65-g100-dimensions.png",
    imageAlt: "Габаритные и присоединительные размеры счётчиков СМТ-Комплекс G65 и G100",
    caption:
      "Тип соединения счётчика с трубопроводом: фланец DN 80\nГабаритные размеры G65/G100, не более 570×210×280 мм"
  }
};
