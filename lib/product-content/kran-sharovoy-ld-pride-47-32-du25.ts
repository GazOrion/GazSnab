...
export const KRAN_SHAROVOY_LD_PRIDE_47_32_DU25_CONTENT: ProductRichContent = {
  ...
  description: [
    ...
    {
      type: "list",
      items: ["L = 74,5 мм", "A = 130 мм", "B = 80 мм"]
    }
  ],
  ...
  specs: [
    {
      ...
      value: "LD Pride, латунь, никель, Ду 32, Ру 25, ВР, рычаг"
    },
    { characteristic: "Модель", value: "47.32.В-В.Р" },
    ...
    { characteristic: "Тип резьбы", value: "1 1/4F-1 1/4F" },
    { characteristic: "Номинальное давление (PN)", value: "25 бар" },
    { characteristic: "Max температура применения", value: "150 °С" },
    { characteristic: "Диаметр трубы", value: "32 мм" },
    { characteristic: "Условный диаметр DN", value: "32 мм" },
