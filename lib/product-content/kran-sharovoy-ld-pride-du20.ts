...
export const KRAN_SHAROVOY_LD_PRIDE_DU20_CONTENT: ProductRichContent = {
  ...
  description: [
    {
      type: "paragraph",
      text: "Кран шаровой латунный LD Pride DN 20 (резьба 3/4″, PN 40) с никелевым покрытием предназначен для жидких сред, неагрессивных к материалам крана, а также пара."
    },
    {
      type: "paragraph",
      text: "Запорный орган — шар с проходным отверстием; поворот рукоятки-рычага обеспечивает полное перекрытие или открытие потока воды. Прямое исполнение с внутренней резьбой на обоих патрубках."
    },
